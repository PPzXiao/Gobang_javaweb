...
<link rel="stylesheet" href="css/paging.css">
  ...
  <div class="rankblock">
  	...
  	<div class="middle-right">
		...
		<div class="start-btn"><a href="RuleServlet"><div class="btn-title" style="text-decoration:none">输赢规则</div></a></div>
		<div class="start-btn"><a href="RulestServlet"><div class="btn-title" style="text-decoration:none">步数规则</div></a></div>
		</c:if>
	</div>
  </div>
