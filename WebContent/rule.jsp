...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>    <title>所有问题页面</title>
  ...
  <div class="container">
	<div class="row clearfix">
     ...
     <c:forEach var="U" items="${rules}" varStatus="userStatus"> 
      <form action="UpdatesServlet" method="post"> 
      <tbody>
       <tr>
	       <td><input type="text" style="border:0px" value="${U.getrWorL()}" name="rWorL" readonly></td>
	       <td><input type="text" style="border:0px" value="${U.geteach1()}" style="border:0px" name="each1"></td>
	       <td>
